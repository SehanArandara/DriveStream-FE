                ...
                {bookings.length === 0 ? (
                  <tr>
                    <td colSpan="5" className="px-8 py-20 text-center flex flex-col items-center">
                      ...
                      <p className="font-black text-slate-400 uppercase tracking-widest text-xs">No pending appointments</p>
                    </td>
                  </tr>
                ) : bookings.map((b) => (
                  <tr key={b._id} className="group hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-8 py-6">
                        <span className={`px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border ${
                          b.status === 'Pending' ? 'bg-amber-50 text-amber-600 border-amber-100' : 'bg-emerald-50 text-emerald-600 border-emerald-100'
                        }`}>
                          {b.status}
                        </span>
                    </td>
